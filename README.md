...
The UI is intentionally seeded for a reliable 90-second contest demo. Durable writes, real speech capture, invitations, and notification delivery are the next implementation slice, not hidden mock claims.
