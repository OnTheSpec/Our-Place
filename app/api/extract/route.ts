...
function demoExtraction() {
  return {
    summary: "Evelyn said the sunshine felt lovely. While watering her tomatoes, she remembered painting a blue porch swing with Frank.", reflection: "You’re feeling pretty good today, and the sunshine has felt lovely. As you watered the tomatoes, you remembered the blue porch swing you painted with Frank.", tone: "Warm and reflective", safety_level: "routine",
    items: [
